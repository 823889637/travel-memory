...
class TripCompanionControllerTest {
    ...
    void ownershipFailureUsesRealHttp404AndKeepsResultBody() throws Exception {
        ...
        TravelMemoryService memoryService = mock(TravelMemoryService.class);
        when(service.listWithStats(20L)).thenThrow(new BusinessException(404, "Trip not found"));
        MockMvc mvc = MockMvcBuilders.standaloneSetup(new TripCompanionController(service, memoryService))
