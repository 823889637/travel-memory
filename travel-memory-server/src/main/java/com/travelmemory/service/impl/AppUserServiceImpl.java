...
public class AppUserServiceImpl implements AppUserService {
 ...
 @Override @Transactional public UserPrincipal updateAvatar(Long userId,String avatarUrl){AppUser user=requireUser(userId);user.setAvatarUrl(avatarUrl);mapper.updateById(user);return new UserPrincipal(user);}
