...
CREATE TABLE travel_trip (
  ...
  destination_country VARCHAR(100) DEFAULT NULL COMMENT 'Destination country parsed from selected city',
  destination_latitude DECIMAL(10, 7) DEFAULT NULL COMMENT 'Destination city center latitude (WGS84)',
  destination_longitude DECIMAL(10, 7) DEFAULT NULL COMMENT 'Destination city center longitude (WGS84)',
...
CREATE TABLE trip_draft (
  ...
  destination_country VARCHAR(100) DEFAULT NULL COMMENT 'Draft destination country parsed from selected city',
  destination_latitude DECIMAL(10, 7) DEFAULT NULL COMMENT 'Draft destination city center latitude (WGS84)',
  destination_longitude DECIMAL(10, 7) DEFAULT NULL COMMENT 'Draft destination city center longitude (WGS84)',
