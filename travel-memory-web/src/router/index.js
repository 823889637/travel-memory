...
const routes = [
  { path: '/', redirect: '/trips' },
  { path: '/login', component: Login, meta: { public: true, mobileStandalone: true } },
  ...
  { path: '/trips/:id/recap', component: TripRecap, props: true, meta: { mobileStandalone: true } },
  { path: '/trips/:id/companions', component: TripCompanions, props: true, meta: { mobileStandalone: true } },
  { path: '/trips/:id/favorites', component: TripTimeline, props: (route) => ({ id: route.params.id, favoriteOnly: true }), meta: { mobileStandalone: true } },
  { path: '/trips/:id', component: TripTimeline, props: true, meta: { mobileStandalone: true } },
  { path: '/trips/:id/memories/new', component: MemoryCreate, props: true, meta: { mobileStandalone: true } },
  { path: '/trips/:tripId/memories/:memoryId', component: MemoryDetail, props: true, meta: { mobileStandalone: true } },
  { path: '/trips/:tripId/memories/:memoryId/edit', component: MemoryEdit, props: true, meta: { mobileStandalone: true } },
  { path: '/trips/:id/map', component: TripMap, props: true, meta: { mobileStandalone: true } },
]
